...
**Note:** The app is only able to group along dimensions (using the leftmost UI section) with less than 50 groups. Trying to group along a dimension that contains more than 50 groups will cause no data to be displayed. 
